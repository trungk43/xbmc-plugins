...
def get_categories():
    ...
    add_link('', 'FOX SPORTS PLUS HD', 0, 'http://113.160.49.34/lives/origin03/foxhd.isml/foxhd.m3u8', thumbnails + 'fox_sports.png', '')
    add_link('', 'HTV7 HD', 0, 'http://frdlzsmb.cdnviet.com/psczntp/_definst_/htv7.720p.stream/playlist.m3u8', thumbnails + 'HTV7.jpg', '')
    add_link('', 'HTV9 HD', 0, 'http://frdlzsmb.cdnviet.com/psczntp/_definst_/htv9.720p.stream/playlist.m3u8', thumbnails + 'HTV9.jpg', '')
    add_link('', 'Thuan Viet HD', 0, 'http://frdlzsmb.cdnviet.com/psczntp/_definst_/thuan_viet.720p.stream/playlist.m3u8', thumbnails + 'ThuanViet.jpg', '')
    add_link('', 'HTVC Phim HD', 0, 'http://frdlzsmb.cdnviet.com/psczntp/_definst_/htvc_movies.720p.stream/playlist.m3u8', thumbnails + 'HTVCHD.jpg', '')
    ...
    #add_link('', 'HTVC plus HD', 0, 'http://frdlzsmb.cdnviet.com/psczntp/_definst_/htvcplus_movies.720p.stream/playlist.m3u8', thumbnails + 'htvcplus_hd.png', '')
    #add_link('', 'HBO HD', 0, '', '', '')
    #add_link('', 'HBO HD', 0, '', '', '')
    #add_link('', 'HBO HD', 0, '', '', '')
    #add_link('', 'HBO HD', 0, '', '', '')
